...
class Account_settings extends CI_Controller {
	...
	function index()
	{
		...
		$this->form_validation->set_rules(array(
			...
			array('field'=>'settings_firstname', 'label'=>'lang:settings_firstname', 'rules'=>'trim|max_length[80]|required'),
			array('field'=>'settings_lastname', 'label'=>'lang:settings_lastname', 'rules'=>'trim|max_length[80]|required'),
