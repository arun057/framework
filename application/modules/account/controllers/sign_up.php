...
class Sign_up extends CI_Controller {
	...
	function index()
	{
		...
		$this->form_validation->set_rules(array(
			...
			array('field'=>'sign_up_firstname', 'label'=>'lang:sign_up_firstname', 'rules'=>'trim|required'),
			array('field'=>'sign_up_lastname', 'label'=>'lang:sign_up_lastname', 'rules'=>'trim|required'),
		...
		if ($this->form_validation->run() === TRUE) 
		{
			...
			else 
			{
				...
				// Create user
				$user_id = $this->account_model->create($this->input->post('sign_up_username'), $this->input->post('sign_up_email'), $this->input->post('sign_up_password'), $this->input->post('sign_up_firstname'), $this->input->post('sign_up_lastname'));

                                $data = array('firstname' => $this->input->post('sign_up_firstname'), 
