    ...
    <div class="container_12">
        ...
        <div class="grid_6">
            ...
            <div class="grid_1 alpha">
                <img src="/resource/account/img/auth_icons/facebook.png" alt="<?php echo lang('connect_facebook'); ?>" title="<?php echo lang('connect_facebook'); ?>" width="40" />
            </div>
            <div class="grid_3">
            ...
            <div class="grid_1 alpha">
                <img src="/resource/account/img/auth_icons/twitter.png" alt="<?php echo lang('connect_twitter'); ?>" title="<?php echo lang('connect_twitter'); ?>" width="40" />
            </div>
            <div class="grid_3">
            ...
            <div class="grid_1 alpha">
                <img src="/resource/account/img/auth_icons/<?php echo $openid_link->provider; ?>.png" alt="<?php echo lang('connect_'.$openid_link->provider); ?>" width="40" />
            </div>
            <div class="grid_3">
